...
class CoachForTest implements ICoach{
    public $name = '';
    public $nafNumer = 0;
    public $raceName = '';
    public function __construct(string $name,int $nafNumer, string $raceName){
      $this->name = $name;
      $this->nafNumber = $nafNumer;
      $this->raceName = $raceName;
    }
    public function getName(): string{
      return $this->name;
    }
    public function getNafNumber(): int{
