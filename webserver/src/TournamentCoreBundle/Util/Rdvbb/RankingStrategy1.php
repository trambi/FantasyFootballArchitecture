...
class RankingStrategy1 implements IRankingStrategy{
  ...
  public function computePoints($game){
    return PointsComputor::win5Draw2SmallLoss1Loss0($game);
  }
  
  public function compareCoachs($team1,$team2){
    return TeamComparator::pointsNetTdCasFor($team1,$team2);
  }
  ...
  public function rankingOptions(){
    return array(
      'coach' => array(
        'main' => array('points','netTd','casualtiesFor'),
        'td' => array('tdFor'),
